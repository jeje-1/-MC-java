...
public class Homework1130_ans {
	...
	public static void q8() {
		//이선승 가위바위보
		//2선승이 결정될 떄까지 사용자로부터 반복해서 입력받아야 함
		Scanner sc = new Scanner(System.in);
		int win = 0;
		int lose = 0;
		int semi = 0;
		...
		while (win < 2 && lose < 2) { 
			...
			if(msg.equals("비겼습니다.")) semi++;
			
			System.out.println(win + "/" + lose + "/" + semi + "/");
			
			System.out.println(msg);
				
		}
		System.out.println(win +"승" + lose + "패" + semi + "무 하였습니다." );
	}
