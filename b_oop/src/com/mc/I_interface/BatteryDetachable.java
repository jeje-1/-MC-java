...
public interface BatteryDetachable {
	...
	//인터페이스의 클래스 메서드는 protected를 제외하고 접근제한자 사용가능
	//private은 자바 9버전부터 사용가능
	public static void printInfo() {
		System.out.println(INFO);
	}
	
	//자바 8버전 이후로 default도입
	//인터페이스 내에서 구현부를 가진 인스턴스메서드 허용
	default void upgradeBatter() {
		System.out.println("배터리를 업그레이드합니다.");
	}
