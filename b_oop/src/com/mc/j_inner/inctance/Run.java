...
//		System.out.println(car);
		...
		//Book클래스의 인스턴스를 생성하지 않더라도, inner static 클래스는 인스턴스화가 가능
		
		///////////////////////////////////////////////////////////////////
		
		//1. 점층적 생성자 패턴
		// 매개변수가 있는 생성자를 사용해 객체를 초기화 하는 객체생성패턴
		...
		// 가독성이 좋다. 어떤 속성에 어떤 값이 초기화 되는지 인스턴스화 하는 코드 상에서 알 수 있다. 
		// 단점 : 불변객체 생성이 불가능
		// 초기화된 속성이 setter를 통해 언제든 변경이 가능
